...
const ZH: Record<string, string> = {
  ...
  "nav.search": "搜索",
  "alert.active_alerts": "活跃告警",
  "alert.no_alerts": "无活跃告警",
  "alert.unresolved": "未处理",
  "alert.dismiss": "忽略",
  "alert.re_check": "重新检查",
  "alert.alert_count": "{count} 个未处理告警",
  "health.title": "系统健康",
  "health.all_operational": "所有系统正常运行",
  "health.degraded": "系统降级",
  "health.down": "系统离线",
  "health.agents": "代理",
  "health.tasks": "任务",
  "health.quota": "配额",
  "health.cost": "成本",
  "health.last_updated": "最后更新",
  "notification.title": "通知",
  "notification.empty": "✅ 没有新通知",
  "notification.mark_all_read": "全部已读",
  "notification.type.alert": "告警",
  "notification.type.billing": "账单",
  "notification.type.system": "系统",
  "notification.type.agent": "代理",
  "notification.just_now": "刚刚",
  "notification.minutes_ago": "{n} 分钟前",
  "notification.hours_ago": "{n} 小时前",
  "notification.days_ago": "{n} 天前",
  "knowledge.title": "知识库",
  ...
  "knowledge.type": "类型",
  "knowledge.status": "状态",
  "knowledge.chunks": "分块数",
  "knowledge.date": "上传日期",
  "knowledge.delete": "删除",
  "knowledge.deleting": "删除中…",
  "knowledge.empty": "暂无文档。拖放或点击上传。",
  "knowledge.no_results": "无匹配搜索",
  "knowledge.drop_hint": "拖放文件到此处，或点击选择",
  "knowledge.status_uploading": "上传中",
  "knowledge.status_ready": "就绪",
  "knowledge.status_error": "错误",
  "knowledge.search_placeholder": "输入搜索关键词…",
  "knowledge.drag_active": "释放文件以上传",
  "knowledge.delete_confirm": "确认删除",
  "knowledge.delete_confirm_body": "确定要删除「{name}」吗？此操作不可撤销。",
  "knowledge.cancel": "取消",
  "knowledge.confirm": "确认",
  "knowledge.error_prefix": "错误",
...
const EN: Record<string, string> = {
  ...
  "knowledge.delete_confirm_body": 'Are you sure you want to delete "{name}"? This cannot be undone.',
